...
class ZohoOAuthPersistenceHandler(object):
    ...
    def save_oauthtokens(self,oAuthTokens):
        try:
            ...
            import logging
            OAuthLogger.add_log("Exception occured while saving oauthtokens into DB ",logging.INFO,ex)
            raise ex
        finally:
            cursor.close()
            connection.close()    
    ...
    def get_oauthtokens(self,userEmail):
        try:
            ...
            import logging
            OAuthLogger.add_log("Exception occured while fetching oauthtokens from DB ",logging.INFO,ex)
            raise ex
        finally:
            cursor.close()
            connection.close()
    def delete_oauthtokens(self,userEmail):
        try:
            ...
            import logging
            OAuthLogger.add_log("Exception occured while deleting oauthtokens from DB ",logging.INFO,ex)
            raise ex
        finally:
            cursor.close()
            connection.close()
...
class ZohoOAuthPersistenceFileHandler(object):
    ...
    def save_oauthtokens(self,oAuthTokens):
        try:
            ...
            import logging
            OAuthLogger.add_log("Exception occured while saving oauthtokens into File ",logging.INFO,ex)
            raise ex
    ...
    def get_oauthtokens(self,userEmail):
        try:
            ...
            import logging
            OAuthLogger.add_log("Exception occured while fetching oauthtokens from File ",logging.INFO,ex)
            raise ex
    ...
    def delete_oauthtokens(self,userEmail):
        try:
            ...
            import logging
            OAuthLogger.add_log("Exception occured while deleting oauthtokens from File ",logging.INFO,ex)
            raise ex
